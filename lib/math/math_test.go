...
func testBinarySafety(t *testing.T, name string, inputs [][]float64) {
	builtin, ok := starlarkmath.Module.Members[name]
	if !ok {
		t.Fatalf("no such builtin: math.%s", name)
	}
...
func TestMathCopysignAllocs(t *testing.T) {
	testBinarySafety(t, "copysign", [][]float64{{1, 1}, {1, -1}})
}
...
func TestMathModAllocs(t *testing.T) {
	testBinarySafety(t, "mod", [][]float64{{5.4, 3}, {1, 0}})
}

func TestMathPowAllocs(t *testing.T) {
	testBinarySafety(t, "pow", [][]float64{{2, 32}, {0, 0}})
}

func TestMathRemainderAllocs(t *testing.T) {
	testBinarySafety(t, "remainder", [][]float64{{5.4, 3}, {1, 0}})
}
...
func TestMathAtan2Allocs(t *testing.T) {
	testBinarySafety(t, "atan2", [][]float64{{5.4, 3}, {1, 0}})
}
...
func TestMathHypotAllocs(t *testing.T) {
	testBinarySafety(t, "hypot", [][]float64{{4, 3}, {1, 0}})
}
