...
// Checklist:
// TODO(kcza): check that the allocations correspond to values, perhaps some primitives may be omitted? (e,g, check boolean allocations)
// // TODO(kcza): check that no allocations are made on a failure? Is this even necessary as Starlark explicitly doesn't support error recovery?
// [x] "abs"
// [x] "all"
// [x] "any"
// [x] "bool"
