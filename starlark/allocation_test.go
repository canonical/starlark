...
func TestAllocTestError(t *testing.T) {
	tDummy := &testing.T{}
	tTest := From(tDummy)
	tTest.Error("asdf")
	if !tDummy.Failed() {
		t.Error("Expected error to fail test")
	}
}

// func TestAllocTestSetMaxAllocs(t *testing.T) {
// 	test := From(t)
// 	test.SetMaxAllocs(10)
// 	// TODO(kcza): complete me!
// }

// func TestAllocTestString(t *testing.T) {
// 	test := From(t)
// 	test.SetMaxAllocs(10)
// 	test.RunString("fail('asdf')")
// }

// func TestAllocTestThread(t *testing.T) {
// 	test := From(t)
// 	test.SetMaxAllocs(10)
// 	test.RunThread(func(thread *starlark.Thread) error {
// 		return nil
// 	})
// }

// func TestAllocTestFunc(t *testing.T) {
// 	test := From(t)
// 	test.SetMaxAllocs(10)
// 	test.RunFunc(func() error { return nil })
// }
...
// 		errors = test.testTrend("reported allocs", reportedAllocs, 1.0)
// 		errors = append(errors, test.testTrend("measured allocs", measuredAllocs, test.OverApproxFactor)...)
