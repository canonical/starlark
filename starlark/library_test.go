...
func (d *dummyIterable) String() string        { return "finiteAllocatingIterable" }
func (d *dummyIterable) Truth() starlark.Bool  { return starlark.True }
func (d *dummyIterable) Type() string          { return "finiteAllocatingIterable" }
